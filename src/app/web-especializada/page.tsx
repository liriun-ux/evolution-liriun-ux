...
export const metadata: Metadata = {
  ...
  description:
    "Sitios web especializados para pequeñas PYMEs que necesitan presentar su negocio, productos o servicios, facilitar el contacto y tener una presencia digital propia.",

  alternates: {
    canonical: "/web-especializada",
  },

  openGraph: {
    title: "Web Especializada | LIRIUN-UX",
    description:
      "Un sitio web pensado para que tu negocio pueda ser encontrado, entendido y contactado por sus clientes.",
    url: "/web-especializada",
    siteName: "LIRIUN-UX",
    locale: "es_BO",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Web Especializada | LIRIUN-UX",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Web Especializada | LIRIUN-UX",
    description:
      "Sitios web especializados para pequeñas PYMEs con estructura, SEO, AEO, productos, contacto y mantenimiento.",
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.liriun-ux.tecnologia.bo/web-especializada#webpage",
      url: "https://www.liriun-ux.tecnologia.bo/web-especializada",
      name: "Web Especializada | LIRIUN-UX",
      headline: "Tu negocio puede ser encontrado y entendido.",
      description:
        "Sitios web especializados para pequeñas PYMEs que necesitan presentar claramente su negocio, productos o servicios y facilitar el contacto con sus clientes.",
      inLanguage: "es-BO",
      ...
      about: {
        "@id":
          "https://www.liriun-ux.tecnologia.bo/web-especializada#product",
      },
    ...
    {
      "@type": "Product",
      "@id": "https://www.liriun-ux.tecnologia.bo/web-especializada#product",

      name: "Web Especializada",

      description:
        "Sitios web especializados para pequeñas PYMEs que necesitan presentar claramente su negocio, productos o servicios, facilitar el contacto con sus clientes y contar con una presencia digital propia.",
...
export default function WebEspecializada() {
  return (
    <>
      <script
    ...
    <Card3D className="hero-content">
          ...
          <p>
            Un sitio web pensado para pequeñas PYMEs que necesitan presentar
            claramente su negocio, sus productos o servicios y facilitar el contacto
            con sus clientes.
          </p>
  ...
  <Card3D className="proceso-conteiner">
    ...
    <div>
      <article>
        ...
        <p>
          Restaurantes, pizzerías, cafeterías y otros negocios de alimentación.
        </p>
      </article>
      ...
      <article>
        <h3>Tiendas</h3>
        <p>
          Negocios de ropa, zapatos, relojes, electrónica y otros productos.
        </p>
      </article>
      ...
      <article>
        <h3>Servicios</h3>
        <p>
          Academias, profesionales, talleres y otros negocios que ofrecen
          servicios.
        </p>
      </article>
    </div>
  ...
  <Card3D className="proceso-conteiner">
    ...
    <div>
      ...
      <article>
        ...
        <p>
          El sitio permite mostrar medios de contacto, como WhatsApp,
      ...
      <article>
        ...
        <p>
          Puedes mostrar la ubicación y la información necesaria para llegar
          a tu negocio.
        </p>
      </article>
    </div>
...
<section className="web-especializada-estructura">
  <Card3D className="proceso-conteiner">
    <header>
      ...
      <p>
        Las páginas no se agregan porque sí. La estructura se define según
        el negocio, sus productos o servicios y lo que sus posibles clientes
        necesitan saber.
      </p>
    </header>
    ...
    <div>
      ...
      <p>
        Dependiendo del negocio, pueden incorporarse páginas adicionales,
        como procesos, promociones, preguntas frecuentes u otra información
        que necesite mayor explicación.
      </p>
    </div>

    <div>
      <h3>Páginas de productos</h3>

      <p>
        Los productos pueden contar con páginas individuales cuando su
        importancia o cantidad de información lo requiera.
      </p>
    </div>
  ...
  <Card3D className="proceso-conteiner">
    ...
    <div>
      <article>
        ...
        <p>
          Se define según el negocio y su identidad visual.
        </p>
      </article>
      ...
      <article>
        <h3>Tipografías</h3>
        <p>
          Se seleccionan para facilitar la lectura y acompañar el estilo del
          negocio.
        </p>
      </article>
      ...
      <article>
        <h3>Composición</h3>
        <p>
          Organizamos los elementos para que la información pueda entenderse
          con facilidad.
        </p>
      </article>
      ...
      <article>
        <h3>Componentes</h3>
        <p>
          Botones, tarjetas, formularios, navegación y otros elementos se
...
<section className="web-especializada-animaciones">
  <Card3D className="proceso-conteiner">
    ...
    <p>
      ...
      su tamaño o modificar su posición al interactuar con él.
    </p>
...
<section className="web-especializada-contenido">
  <Card3D className="proceso-conteiner">
    ...
    <p>
      puede transformarse en una descripción más clara como:
    </p>
...
<section className="web-especializada-seo-aeo">
  <Card3D className="proceso-conteiner">
    <header>
      ...
      <p>
        El sitio se estructura para facilitar que el negocio sea encontrado
        y entendido.
      </p>
    </header>
    ...
    <div>
      ...
      <article>
        <h3>Para sistemas de IA</h3>

        <p>
          La información se presenta de forma clara y estructurada para
          facilitar que los sistemas que trabajan con información pública
...
<section className="web-especializada-cambios">
  <Card3D className="proceso-conteiner">
    ...
    <p>
      Los cambios que modifican significativamente el sitio tienen un costo
      adicional.
    </p>
    ...
    <ul>
      ...
      <li>
        Cambios estructurales: presupuesto según la complejidad.
      </li>
    </ul>
...
<section className="web-especializada-no-incluye">
  <Card3D className="proceso-conteiner">
    ...
    <ul>
      ...
      <li>Funciones empresariales complejas.</li>
    </ul>
...
<section className="web-especializada-precio">
  <Card3D className="proceso-conteiner">
    ...
    <div>
      ...
      <p>
        El plazo comienza desde el pago inicial de 200 Bs.
      </p>
    </div>

    <p>
      El precio está pensado para las necesidades habituales de pequeñas PYMEs.
...
<section className="web-especializada-despues">
  <Card3D className="proceso-conteiner">
    ...
    <ol>
      ...
      <li>
        Coordinamos la reunión para conocer tu negocio.
      </li>

      <li>
        Realizamos el pago inicial.
      </li>

      <li>
        LIRIUN-UX organiza la información y estructura el sitio.
      </li>
      ...
      <li>
        Revisas el sitio terminado.
      </li>

      <li>
        Realizamos los ajustes correspondientes.
      </li>

      <li>
        Publicamos y entregamos el sitio.
      </li>

      <li>
        Comienzan los tres meses de mantenimiento.
      </li>
    </ol>
...
<section className="web-especializada-cta">
  <Card3D className="proceso-conteiner">
    ...
    <p>
      Cuéntanos qué hace tu negocio y qué quieres mostrar. Te explicaremos
